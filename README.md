...
The dataset used for this project is an e-commerce sales dataset provided as part of the Decode Labs Data Analytics Internship. It simulates real-world transactional data from an online store, capturing customer orders across multiple products, payment methods, and referral sources.
